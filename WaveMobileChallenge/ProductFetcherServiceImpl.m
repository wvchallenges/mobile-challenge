...
-(void)fetchProducts:(ProductFetchSuccessBlock) success failure:(ProductFetchFailureBlock) failure
{
    ...
    NSAssert(self.productBuilder != nil, @"self.productBuilder must be initialized!");
    NSAssert(self.httpOperationsFactory != nil, @"self.httpOperationsFactory must be initialized!");
