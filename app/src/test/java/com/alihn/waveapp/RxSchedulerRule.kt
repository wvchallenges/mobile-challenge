...
class RxSchedulerRule : TestRule {
    ...
    private val schedulerFunction = Function<Scheduler, Scheduler> { trampoline }

    private val schedulerFunctionLazy = Function<Callable<Scheduler>, Scheduler> { trampoline }
