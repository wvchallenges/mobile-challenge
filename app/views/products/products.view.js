...
const Products = props => {
	...
	return (
		<SafeAreaView>
			{isconnected ? (
				<ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => _onRefresh()} title={'Refreshing the products list'} />}>
					<View style={styles.mainView}>
						<FlatList
							data={products || []}
							renderItem={({ item, index }) => <Item title={item.name} price={item.price} id={item.id} />}
